...
function serializeState() {
  return {
    ...
    eyes: Object.fromEntries(EYES.map((eye) => [eye, {
      items: state.eyes[eye].items.map(({ id, type, x, y, rotation, scale, density, contrast, blur, structure, driftSeed, eye: itemEye }) => ({ id, type, x, y, rotation, scale, density, contrast, blur, structure, driftSeed, eye: itemEye })),
